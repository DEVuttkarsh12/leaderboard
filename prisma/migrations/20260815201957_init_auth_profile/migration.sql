...
-- CreateIndex
CREATE INDEX "CasinoAccount_provider_username_idx" ON "CasinoAccount"("provider", "username");

-- CreateIndex
CREATE UNIQUE INDEX "CasinoAccount_userId_provider_key" ON "CasinoAccount"("userId", "provider");
