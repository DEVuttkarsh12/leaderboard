  ...
  useEffect(() => {
    ...
    class AutoDriver {
      ...
      update() {
        ...
        const direction = this._tmpDir.subVectors(this.target, this.current);
    ...
    class Advection extends ShaderPass {
      ...
      update({ dt: nextDt, isBounce: bounce, BFECC: nextBFECC }) {
    ...
    class WebGLManager {
      ...
      dispose() {
        ...
        const targets = this.output?.simulation?.fbos
          ? Object.values(this.output.simulation.fbos)
          : [];
        targets.forEach((target) => target?.dispose?.());
        this.output?.output?.geometry?.dispose?.();
        this.output?.output?.material?.dispose?.();
      }
    }
